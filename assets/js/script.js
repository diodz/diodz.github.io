          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <a href="/" className="flex-shrink-0">
                <span className="text-xl font-bold">Diego Díaz</span>
              </a>
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <a href="/" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">Home</a>
                <a href="/about.html" className="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-700">About</a>
              </div>
            </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <a href="/about.html" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-700">About</a>
            </div>
          </div>
        )}
      </nav>
